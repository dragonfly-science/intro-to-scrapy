...
```{r}
sample_size <- 15
random_boys   <- sort(sample(babynames[babynames$gender == "boy",    ][[1]], sample_size))
random_girls  <- sort(sample(babynames[babynames$gender == "girl",   ][[1]], sample_size))
random_unisex <- sort(sample(babynames[babynames$gender == "unisex", ][[1]], sample_size))
```
