...
```{r}
sample_size <- 15
random_boys   <- sort(sample(babynames[babynames$gender == "boy",    ], sample_size))
random_girls  <- sort(sample(babynames[babynames$gender == "girl",   ], sample_size))
random_unisex <- sort(sample(babynames[babynames$gender == "unisex", ], sample_size))
```
